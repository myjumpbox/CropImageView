...
//                        }
                        ...
                        if (mFloatDrawableRectF != null) {
                            if (rectF.left + dx >= mFloatDrawableRectF.left) {
                                dx = 0;
                            }
                            if (rectF.top + dy >= mFloatDrawableRectF.top) {
                                dy = 0;
                            }

                            if (rectF.right + dx <= mFloatDrawableRectF.right) {
                                dx = 0;
                            }
                            if (rectF.bottom + dy <= mFloatDrawableRectF.bottom) {
                                dy = 0;
                            }
...
//                        checkBorderAndCenterWhenScale();
     ...
     * 设置浮层rectF
     */
    private RectF mFloatDrawableRectF;

    public void setFloatDrawableRect(RectF rectF) {
        mFloatDrawableRectF = rectF;
